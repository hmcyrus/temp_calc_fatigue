# -*- coding: utf-8 -*-
"""
Created on Thu Apr 19 13:45:52 2018
...
# from Towergeo
# from C to J
Hcan,base (z_bottom)	K25:K73
Buckling section length (bs_l - real lenght of section) 
Dcan,base	(D_out_bottom) M25:M73
Dcan,top	(D_out_top) N25:N73
b	(used three places in workbook)
tcan	(thickness) # (D_out_bottom-D_in_bottom) / 2
tcan, mod	 (t_m) - note in sheet
Rcan,ave,base (b_r2 ) [can.py -> 185]

# from E_loads
# from K to X
b_fyk  [can.py -> 189]	 -- "strength_yield" from Library
General_Inputs(C60) - can_material
can.py -- 189 <- 146 <- 722(tower.py-calls can.calc_margin_extreme) <- 701 <- 700 


# [can.py -> 153]
# set_extreme_loads() in tower.py set these values for all elements
e_V	
e_P	
e_M	
e_Mt
...
e_stress_axial_force	
e_stress_moment	
e_stress_total	
e_shear_radial_force	
e_shear_torsion	
e_shear_total	
e_stress_vonMises	
e_stress_yield_design	
margin_extreme_yield
